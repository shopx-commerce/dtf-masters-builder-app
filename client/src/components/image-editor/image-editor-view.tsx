          ...
          <div className="flex min-h-0 flex-1 flex-col">
              ...
              <div className="relative min-h-0 min-w-0 flex-1">
                <PreviewSection
                  ...
                  /* TODO: backdropSwatchContainer={backdropSwatchHost}, onRegisterFocus={registerCanvasFocus}
                     — the backdrop-color preview-swatch feature and the "focus selected
                     design after a tool runs" behavior both live in a large, not-yet-ported
                     `preview-section.tsx` rewrite (touch hit-targets, viewport culling, ruler
                     gutters, RotationBadge, ~1200-line diff). Deferred as a separate
                     follow-up; both are harmless no-ops without it — the view bar's
                     swatch-host div stays empty and `minimiseToolsAndFocus()` just skips the
                     focus step. */
                   wandDeleteActive={wandDeleteModeActive}
