 ...
 * edge). Returns 1 when already within budget.
 *
 * Kept as a local copy rather than imported from the shared image-budget
 * module: that module's megapixel-budget helpers are part of a separate,
 * larger raster-upload rewrite outside the scope of this port, and this
 * function is small, pure, and self-contained.
 */
